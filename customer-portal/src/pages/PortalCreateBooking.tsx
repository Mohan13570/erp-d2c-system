...
import { generateCommercialInvoice, generateShippingLabel } from '../lib/DocumentGenerator';
...
export default function PortalCreateBooking() {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      generateCommercialInvoice(finalData, mockBookingId);
      generateShippingLabel(finalData, mockBookingId);
