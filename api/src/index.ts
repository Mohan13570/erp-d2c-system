...
import trackingLiveRouter from './routes/tracking-live';
import trackingTimelineRouter from './routes/tracking-timeline';
import trackingDashboardRouter from './routes/tracking-dashboard';
import trackingRouteRouter from './routes/tracking-route';
import trackingBarcodeRouter from './routes/tracking-barcode';
import publicTrackingRouter from './routes/public-tracking';
import trackingAnalyticsRouter from './routes/tracking-analytics';
import documentsRouter from './routes/documents';
import shipmentBillingRouter from './routes/shipment-billing';
import shipmentWorkflowRouter from './routes/shipment-workflow';
import executiveAnalyticsRouter from './routes/executive-analytics';
import warehouseMasterRouter from './routes/warehouse-master';
import warehouseStructureRouter from './routes/warehouse-structure';
import warehouseInboundRouter from './routes/warehouse-inbound';
import warehousePutawayRouter from './routes/warehouse-putaway';
...
app.use('/api/v1', trackingLiveRouter);
app.use('/api/v1', trackingTimelineRouter);
app.use('/api/v1', trackingDashboardRouter);
app.use('/api/v1', trackingRouteRouter);
app.use('/api/v1', trackingBarcodeRouter);
app.use('/api/v1', publicTrackingRouter);
app.use('/api/v1', trackingAnalyticsRouter);
app.use('/api/v1', documentsRouter);
app.use('/api/v1', shipmentBillingRouter);
app.use('/api/v1', shipmentWorkflowRouter);
app.use('/api/v1/executive/analytics', executiveAnalyticsRouter);
app.use('/api/v1/warehouses', warehouseMasterRouter);
app.use('/api/v1/warehouse-structure', warehouseStructureRouter);
app.use('/api/v1/warehouse-inbound', warehouseInboundRouter);
app.use('/api/v1/warehouse-putaway', warehousePutawayRouter);
