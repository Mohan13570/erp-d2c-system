          ...
          <footer className="bg-gray-50 border-t border-gray-100 py-16 mt-auto">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                <div>
                  <span className="text-2xl font-black tracking-tighter">AURA<span className="text-indigo-600">.</span></span>
                ...
                <p className="text-gray-400 text-sm">&copy; 2026 Aura Design.</p>
              </div>
            </div>
          </footer>
        </CartProvider>
